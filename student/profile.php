<?php
$page_title = "Manage Profile - Anniyappa Publications";
...
<div class="container py-5">
  <div class="row g-4">
    ...
    <div class="col-lg-3">
      <div class="card border-0 shadow-sm p-4 text-center bg-light" style="border-radius:15px;">
        ...
        <div class="list-group list-group-flush text-start small" style="border-radius: 10px; overflow:hidden;">
          ...
          <a href="/student/profile.php" class="list-group-item list-group-item-action active text-white bg-primary"><i class="bi bi-person me-2"></i>Edit Profile</a>
        </div>
      </div>
    </div>
    ...
    <!-- Main Content Panel -->
    <div class="col-lg-9">
      <h2 class="font-title fw-bold text-dark mb-4 h3"><i class="bi bi-person-gear me-2 text-primary"></i>Profile Settings</h2>
      ...
      <div class="card border-0 shadow-sm p-4 p-lg-5" style="border-radius:15px;">
        ...
        <form action="/student/profile.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="row mb-4 align-items-center">
            <div class="col-md-3 text-center text-md-start">
              <div class="bg-secondary text-white rounded-circle d-inline-flex align-items-center justify-content-center fw-bold fs-2 shadow-sm" style="width:100px; height:100px;">
                <?php echo substr($profile['full_name'] ?? 'S', 0, 1); ?>
              </div>
            </div>
            <div class="col-md-9 mt-3 mt-md-0">
              <label for="profile_pic" class="form-label small text-muted">Upload Profile Picture (PNG/JPG)</label>
          ...
          <div class="mb-3">
            <label for="address" class="form-label small text-muted">Billing / Contact Address</label>
            <textarea name="address" id="address" rows="3" class="form-control bg-light" placeholder="Enter shipping or billing address details..."><?php echo sanitize($profile['address']); ?></textarea>
          </div>

          <div class="mb-4">
            <label for="bio" class="form-label small text-muted">Biography Outline</label>
            <textarea name="bio" id="bio" rows="4" class="form-control bg-light" placeholder="Tell us about your research details, learning interests, university major, etc..."><?php echo sanitize($profile['bio']); ?></textarea>
          </div>
